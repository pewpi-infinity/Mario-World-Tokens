...
export function WalletBalance({ stats }: WalletBalanceProps) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
      ...
      <Card className="p-4 sm:p-6 bg-gradient-to-br from-[oklch(0.70_0.24_190)] to-[oklch(0.75_0.26_190)] border-2 border-[oklch(0.75_0.26_190)] text-white sm:col-span-2 lg:col-span-1">
        <div className="flex items-center justify-between">
          <div className="min-w-0 flex-1">
